...
final class ImplicitIgnoredAnnotationNames
{
    ...
    private const PHPCheckStyle = [5 * self::SLOT_SIZE => 'SuppressWarnings'];

    private const PhpStorm = [6 * self::SLOT_SIZE => 'noinspection'];

    private const PEAR = [7 * self::SLOT_SIZE => 'package_version'];
